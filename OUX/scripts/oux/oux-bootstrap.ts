...
define(["oux-core"], function (oux: angular.IModule) {
    oux.run(["$templateCache", "$log", function (
        ...
        $templateCache.put("ouxForm.html",
            "<div class=\"panel panel-default form-horizontal oux-form\" ng-form=\"form\">" +
        ...
        $templateCache.put("ouxInput.html",
            "<div class=\"form-group\" ng-form=\"form\" ng-class=\"{'has-error': ouxInput.invalid}\">" +
